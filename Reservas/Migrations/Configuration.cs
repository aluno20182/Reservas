    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ReservasDB>
    {
        ...
        protected override void Seed(ReservasDB context)
        {
            ...
            var reservaLugar = new List<ReservaLugar> {
               new ReservaLugar {ID=7, LocalDaReserva="Abrantes", DataDaReserva=new DateTime(2017, 3, 9, 3, 57, 11), ViaturaFK=10, ClienteFK=17, TecnicoFK=1, UserNameID="reserva"},
               new ReservaLugar {ID=23, LocalDaReserva="Abrantes", DataDaReserva=new DateTime(2017,8,9), ViaturaFK=15, ClienteFK=23, TecnicoFK=1, UserNameID="rl"  },
               new ReservaLugar {ID=26, LocalDaReserva="Abrantes", DataDaReserva=new DateTime(2017,8,18), ViaturaFK=17, ClienteFK=6, TecnicoFK=1 },
               new ReservaLugar {ID=64, LocalDaReserva="Abrantes", DataDaReserva=new DateTime(2017,3,24), ViaturaFK=5, ClienteFK=16, TecnicoFK=1 },
               new ReservaLugar {ID=14, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,2,12), ViaturaFK=9, ClienteFK=15, TecnicoFK=2 },
               new ReservaLugar {ID=20, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,4,27), ViaturaFK=11, ClienteFK=29, TecnicoFK=2 },
               new ReservaLugar {ID=46, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,5,3), ViaturaFK=9, ClienteFK=22, TecnicoFK=2 },
               new ReservaLugar {ID=65, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,3,18), ViaturaFK=6, ClienteFK=25, TecnicoFK=2 },
               new ReservaLugar {ID=67, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,2,20), ViaturaFK=19, ClienteFK=2, TecnicoFK=2 },
               new ReservaLugar {ID=113, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,8,27), ViaturaFK=6, ClienteFK=22, TecnicoFK=2 },
               new ReservaLugar {ID=52, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,8,16), ViaturaFK=18, ClienteFK=2, TecnicoFK=3 },
               new ReservaLugar {ID=61, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,1,19), ViaturaFK=13, ClienteFK=13, TecnicoFK=3 },
               new ReservaLugar {ID=77, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,5,6), ViaturaFK=11, ClienteFK=10, TecnicoFK=3 },
               new ReservaLugar {ID=109, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,6,15), ViaturaFK=16, ClienteFK=23, TecnicoFK=3 },
               new ReservaLugar {ID=12, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,3,24), ViaturaFK=6, ClienteFK=19, TecnicoFK=5 },
               new ReservaLugar {ID=31, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,4,16), ViaturaFK=11, ClienteFK=1, TecnicoFK=5 },
               new ReservaLugar {ID=44, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,9,15), ViaturaFK=19, ClienteFK=17, TecnicoFK=5 },
               new ReservaLugar {ID=47, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,7,13), ViaturaFK=9, ClienteFK=28, TecnicoFK=5 },
               new ReservaLugar {ID=55, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,7,2), ViaturaFK=11, ClienteFK=21, TecnicoFK=5 },
               new ReservaLugar {ID=72, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,6,17), ViaturaFK=1, ClienteFK=7, TecnicoFK=5 },
               new ReservaLugar {ID=90, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,7,21), ViaturaFK=4, ClienteFK=29, TecnicoFK=5 },
               new ReservaLugar {ID=105, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,4,16), ViaturaFK=6, ClienteFK=11, TecnicoFK=5 },
               new ReservaLugar {ID=5, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,2,22), ViaturaFK=11, ClienteFK=13, TecnicoFK=6 },
               new ReservaLugar {ID=6, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,8,2), ViaturaFK=16, ClienteFK=5, TecnicoFK=6 },
               new ReservaLugar {ID=43, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,2,5), ViaturaFK=2, ClienteFK=6, TecnicoFK=6 },
               new ReservaLugar {ID=48, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,6,20), ViaturaFK=3, ClienteFK=12, TecnicoFK=6 },
               new ReservaLugar {ID=50, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,1,6), ViaturaFK=16, ClienteFK=15, TecnicoFK=6 },
               new ReservaLugar {ID=53, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,4,7), ViaturaFK=15, ClienteFK=16, TecnicoFK=6 },
               new ReservaLugar {ID=54, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,8,21), ViaturaFK=11, ClienteFK=4, TecnicoFK=6 },
               new ReservaLugar {ID=66, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,6,28), ViaturaFK=10, ClienteFK=3, TecnicoFK=6 },
               new ReservaLugar {ID=70, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,7,14), ViaturaFK=18, ClienteFK=26, TecnicoFK=6 },
               new ReservaLugar {ID=80, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,1,16), ViaturaFK=1, ClienteFK=27, TecnicoFK=6 },
               new ReservaLugar {ID=81, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,9,22), ViaturaFK=19, ClienteFK=18, TecnicoFK=6 },
               new ReservaLugar {ID=85, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,2,27), ViaturaFK=17, ClienteFK=10, TecnicoFK=6 },
               new ReservaLugar {ID=1, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,2,4), ViaturaFK=14, ClienteFK=8, TecnicoFK=7 },
               new ReservaLugar {ID=25, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,6,21), ViaturaFK=6, ClienteFK=11, TecnicoFK=7 },
               new ReservaLugar {ID=34, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,4,10), ViaturaFK=8, ClienteFK=11, TecnicoFK=7 },
               new ReservaLugar {ID=40, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,8,24), ViaturaFK=14, ClienteFK=17, TecnicoFK=7 },
               new ReservaLugar {ID=83, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,5,15), ViaturaFK=8, ClienteFK=13, TecnicoFK=7 },
               new ReservaLugar {ID=106, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,8,21), ViaturaFK=16, ClienteFK=15, TecnicoFK=7 },
               new ReservaLugar {ID=9, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,6,18), ViaturaFK=5, ClienteFK=6, TecnicoFK=9 },
               new ReservaLugar {ID=21, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,8,14), ViaturaFK=7, ClienteFK=8, TecnicoFK=9 },
               new ReservaLugar {ID=73, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,7,5), ViaturaFK=19, ClienteFK=6, TecnicoFK=9 },
               new ReservaLugar {ID=74, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,2,25), ViaturaFK=19, ClienteFK=22, TecnicoFK=9 },
               new ReservaLugar {ID=99, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,6,8), ViaturaFK=18, ClienteFK=11, TecnicoFK=9 },
               new ReservaLugar {ID=102, LocalDaReserva="Entroncamento", DataDaReserva=new DateTime(2017,3,25), ViaturaFK=13, ClienteFK=21, TecnicoFK=9 },
               new ReservaLugar {ID=11, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,8,14), ViaturaFK=6, ClienteFK=13, TecnicoFK=4 },
               new ReservaLugar {ID=18, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,1,5), ViaturaFK=4, ClienteFK=7, TecnicoFK=4 },
               new ReservaLugar {ID=38, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,7,9), ViaturaFK=9, ClienteFK=30, TecnicoFK=4 },
               new ReservaLugar {ID=51, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,2,28), ViaturaFK=7, ClienteFK=19, TecnicoFK=4 },
               new ReservaLugar {ID=76, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,2,10), ViaturaFK=15, ClienteFK=4, TecnicoFK=4 },
               new ReservaLugar {ID=108, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,6,2), ViaturaFK=11, ClienteFK=20, TecnicoFK=4 },
               new ReservaLugar {ID=100, LocalDaReserva="Ourém", DataDaReserva=new DateTime(2017,9,23), ViaturaFK=17, ClienteFK=13, TecnicoFK=7 },
               new ReservaLugar {ID=107, LocalDaReserva="Ourém", DataDaReserva=new DateTime(2017,4,9), ViaturaFK=11, ClienteFK=3, TecnicoFK=7 },
               new ReservaLugar {ID=112, LocalDaReserva="Ourém", DataDaReserva=new DateTime(2017,4,18), ViaturaFK=11, ClienteFK=6, TecnicoFK=7 },
               new ReservaLugar {ID=27, LocalDaReserva="Torres Novas", DataDaReserva =new DateTime(2017,3,21), ViaturaFK=15, ClienteFK=15, TecnicoFK=7 },
               new ReservaLugar {ID=111, LocalDaReserva="Torres Novas", DataDaReserva=new DateTime(2017,8,22), ViaturaFK=3, ClienteFK=7, TecnicoFK=7 },
               new ReservaLugar {ID=30, LocalDaReserva="Torres Novas", DataDaReserva=new DateTime(2017,6,23), ViaturaFK=4, ClienteFK=16, TecnicoFK=10 },
               new ReservaLugar {ID=75, LocalDaReserva="Torres Novas", DataDaReserva=new DateTime(2017,5,20), ViaturaFK=8, ClienteFK=20, TecnicoFK=10 },
               new ReservaLugar {ID=2, LocalDaReserva="Torres Novas", DataDaReserva=new DateTime(2017,7,1), ViaturaFK=6, ClienteFK=26, TecnicoFK=9 },
               new ReservaLugar {ID=8, LocalDaReserva="Torres Novas", DataDaReserva=new DateTime(2017,6,9), ViaturaFK=5, ClienteFK=3, TecnicoFK=5 },
               new ReservaLugar {ID=22, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,5,1), ViaturaFK=15, ClienteFK=3, TecnicoFK=8 },
               new ReservaLugar {ID=35, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,5,17), ViaturaFK=10, ClienteFK=26, TecnicoFK=8 },
               new ReservaLugar {ID=37, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,3,3), ViaturaFK=2, ClienteFK=17, TecnicoFK=8 },
               new ReservaLugar {ID=39, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,9,19), ViaturaFK=8, ClienteFK=11, TecnicoFK=8 },
               new ReservaLugar {ID=49, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,9,17), ViaturaFK=5, ClienteFK=22, TecnicoFK=8 },
               new ReservaLugar {ID=78, LocalDaReserva="Leiria", DataDaReserva=new DateTime(2017,3,13), ViaturaFK=5, ClienteFK=14, TecnicoFK=8 },
               new ReservaLugar {ID=10, LocalDaReserva="Santarém", DataDaReserva=new DateTime(2017,2,18), ViaturaFK=11, ClienteFK=19, TecnicoFK=8 },
               new ReservaLugar {ID=103, LocalDaReserva="Santarém", DataDaReserva=new DateTime(2017,8,28), ViaturaFK=12, ClienteFK=5, TecnicoFK=8 },
               new ReservaLugar {ID=97, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,7,8), ViaturaFK=6, ClienteFK=26, TecnicoFK=6 },
               new ReservaLugar {ID=115, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,8,4, 14,58,13), ViaturaFK=3, ClienteFK=4, TecnicoFK=6 }
            };
