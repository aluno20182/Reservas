    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ReservasDB>
    {
        ...
        protected override void Seed(ReservasDB context)
        {
            ...
            var reservas = new List<Reservas> {
               ...
               new Reservas {ID=14, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,2,12), ViaturaFK=9, ClienteFK=15, TecnicoFK=2 },
               new Reservas {ID=20, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,4,27), ViaturaFK=11, ClienteFK=29, TecnicoFK=2 },
               new Reservas {ID=46, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,5,3), ViaturaFK=9, ClienteFK=22, TecnicoFK=2 },
               new Reservas {ID=65, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,3,18), ViaturaFK=6, ClienteFK=25, TecnicoFK=2 },
               new Reservas {ID=67, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,2,20), ViaturaFK=19, ClienteFK=2, TecnicoFK=2 },
               new Reservas {ID=113, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,8,27), ViaturaFK=6, ClienteFK=22, TecnicoFK=2 },
               new Reservas {ID=52, LocalDaReserva="Leiria", DataDaEntrada=new DateTime(2017,8,16), ViaturaFK=18, ClienteFK=2, TecnicoFK=3 },
               new Reservas {ID=61, LocalDaReserva="Leiria", DataDaEntrada=new DateTime(2017,1,19), ViaturaFK=13, ClienteFK=13, TecnicoFK=3 },
               new Reservas {ID=77, LocalDaReserva="Leiria", DataDaEntrada=new DateTime(2017,5,6), ViaturaFK=11, ClienteFK=10, TecnicoFK=3 },
               new Reservas {ID=109, LocalDaReserva="Leiria", DataDaEntrada=new DateTime(2017,6,15), ViaturaFK=16, ClienteFK=23, TecnicoFK=3 },
               new Reservas {ID=4, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,9,15), ViaturaFK=11, ClienteFK=17, TecnicoFK=4 },
               new Reservas {ID=15, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,8,12), ViaturaFK=18, ClienteFK=5, TecnicoFK=4 },
               new Reservas {ID=19, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,2,7), ViaturaFK=18, ClienteFK=18, TecnicoFK=4 },
               new Reservas {ID=28, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,7,9), ViaturaFK=3, ClienteFK=3, TecnicoFK=4 },
               new Reservas {ID=36, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,5,7), ViaturaFK=17, ClienteFK=17, TecnicoFK=4 },
               new Reservas {ID=45, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,7,26), ViaturaFK=18, ClienteFK=14, TecnicoFK=4 },
               new Reservas {ID=92, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,2,22), ViaturaFK=16, ClienteFK=6, TecnicoFK=4 },
               new Reservas {ID=12, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,3,24), ViaturaFK=6, ClienteFK=19, TecnicoFK=5 },
               new Reservas {ID=31, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,4,16), ViaturaFK=11, ClienteFK=1, TecnicoFK=5 },
               new Reservas {ID=44, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,9,15), ViaturaFK=19, ClienteFK=17, TecnicoFK=5 },
               new Reservas {ID=47, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,7,13), ViaturaFK=9, ClienteFK=28, TecnicoFK=5 },
               new Reservas {ID=55, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,7,2), ViaturaFK=11, ClienteFK=21, TecnicoFK=5 },
               new Reservas {ID=72, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,6,17), ViaturaFK=1, ClienteFK=7, TecnicoFK=5 },
               new Reservas {ID=90, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,7,21), ViaturaFK=4, ClienteFK=29, TecnicoFK=5 },
               new Reservas {ID=105, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,4,16), ViaturaFK=6, ClienteFK=11, TecnicoFK=5 },
               ...
               new Reservas {ID=17, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,4,10), ViaturaFK=13, ClienteFK=28, TecnicoFK=8 },
               new Reservas {ID=29, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,7,23), ViaturaFK=19, ClienteFK=10, TecnicoFK=8 },
               new Reservas {ID=63, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,8,26), ViaturaFK=10, ClienteFK=24, TecnicoFK=8 },
               new Reservas {ID=68, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,6,24), ViaturaFK=14, ClienteFK=13, TecnicoFK=8 },
               new Reservas {ID=82, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,2,7), ViaturaFK=8, ClienteFK=11, TecnicoFK=8 },
               new Reservas {ID=89, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,4,10), ViaturaFK=19, ClienteFK=19, TecnicoFK=8 },
               new Reservas {ID=95, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,7,16), ViaturaFK=10, ClienteFK=8, TecnicoFK=8 },
               new Reservas {ID=96, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,3,23), ViaturaFK=8, ClienteFK=22, TecnicoFK=8 },
               new Reservas {ID=9, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,6,18), ViaturaFK=5, ClienteFK=6, TecnicoFK=9 },
               new Reservas {ID=21, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,8,14), ViaturaFK=7, ClienteFK=8, TecnicoFK=9 },
               new Reservas {ID=73, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,7,5), ViaturaFK=19, ClienteFK=6, TecnicoFK=9 },
               new Reservas {ID=74, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,2,25), ViaturaFK=19, ClienteFK=22, TecnicoFK=9 },
               new Reservas {ID=99, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,6,8), ViaturaFK=18, ClienteFK=11, TecnicoFK=9 },
               new Reservas {ID=102, LocalDaReserva="Alcanena", DataDaEntrada=new DateTime(2017,3,25), ViaturaFK=13, ClienteFK=21, TecnicoFK=9 },
               new Reservas {ID=3, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,8,3), ViaturaFK=18, ClienteFK=3, TecnicoFK=10 },
               new Reservas {ID=13, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,1,9), ViaturaFK=5, ClienteFK=17, TecnicoFK=10 },
               new Reservas {ID=32, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,6,20), ViaturaFK=12, ClienteFK=17, TecnicoFK=10 },
               new Reservas {ID=41, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,5,13), ViaturaFK=1, ClienteFK=25, TecnicoFK=10 },
               new Reservas {ID=42, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,6,1), ViaturaFK=19, ClienteFK=14, TecnicoFK=10 },
               new Reservas {ID=56, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,3,5), ViaturaFK=17, ClienteFK=5, TecnicoFK=10 },
               ...
               new Reservas {ID=62, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,5,12), ViaturaFK=10, ClienteFK=26, TecnicoFK=6 },
               new Reservas {ID=86, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,2,13), ViaturaFK=2, ClienteFK=7, TecnicoFK=6 },
               new Reservas {ID=33, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,8,9), ViaturaFK=7, ClienteFK=7, TecnicoFK=7 },
               new Reservas {ID=60, LocalDaReserva="Ourém",  DataDaEntrada=new DateTime(2017,4,28), ViaturaFK=13, ClienteFK=13, TecnicoFK=7 },
               new Reservas {ID=79, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,7,8), ViaturaFK=15, ClienteFK=3, TecnicoFK=7 },
               new Reservas {ID=84, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,9,20), ViaturaFK=4, ClienteFK=7, TecnicoFK=7 },
               new Reservas {ID=87, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,5,15), ViaturaFK=12, ClienteFK=22, TecnicoFK=7 },
               new Reservas {ID=91, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,4,28), ViaturaFK=7, ClienteFK=27, TecnicoFK=7 },
               new Reservas {ID=94, LocalDaReserva="Ourém", DataDaEntrada=new DateTime(2017,6,5), ViaturaFK=5, ClienteFK=4, TecnicoFK=7 },
               ...
               new Reservas {ID=57, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,4,28), ViaturaFK=1, ClienteFK=15, TecnicoFK=9 },
               new Reservas {ID=59, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,4,2), ViaturaFK=10, ClienteFK=24, TecnicoFK=5 },
               new Reservas {ID=71, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,8,4), ViaturaFK=9, ClienteFK=19, TecnicoFK=9 },
               new Reservas {ID=101, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,7,16), ViaturaFK=8, ClienteFK=18, TecnicoFK=5 },
               new Reservas {ID=110, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,5,25), ViaturaFK=3, ClienteFK=27, TecnicoFK=9 },
               new Reservas {ID=114, LocalDaReserva="Torres Novas", DataDaEntrada=new DateTime(2017,3,8), ViaturaFK=14, ClienteFK=28, TecnicoFK=5 },
               new Reservas {ID=16, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,9,13), ViaturaFK=6, ClienteFK=15, TecnicoFK=3 },
               new Reservas {ID=24, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,8,15), ViaturaFK=19, ClienteFK=28, TecnicoFK=3 },
               new Reservas {ID=58, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,3,28), ViaturaFK=6, ClienteFK=20, TecnicoFK=3 },
               new Reservas {ID=69, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,9,25), ViaturaFK=5, ClienteFK=14, TecnicoFK=3 },
               new Reservas {ID=88, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,6,1), ViaturaFK=1, ClienteFK=6, TecnicoFK=3 },
               new Reservas {ID=93, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,1,14), ViaturaFK=14, ClienteFK=30, TecnicoFK=3 },
               new Reservas {ID=98, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,8,24), ViaturaFK=8, ClienteFK=23, TecnicoFK=3 },
               new Reservas {ID=104, LocalDaReserva="Lisboa", DataDaEntrada=new DateTime(2017,5,18), ViaturaFK=19, ClienteFK=17, TecnicoFK=3 },
               ...
               new Reservas {ID=115, LocalDaReserva="Tomar", DataDaEntrada=new DateTime(2017,8,4), ViaturaFK=3, ClienteFK=4, TecnicoFK=6 }
            };
