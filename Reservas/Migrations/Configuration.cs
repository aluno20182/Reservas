    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ReservasDB>
    {
        ...
        protected override void Seed(ReservasDB context)
        {
            ...
            var reservaLugares = new List<ReservaLugares> {
               new ReservaLugares {ID=1, LocalDaReserva="Abrantes", DataDaReserva=new DateTime(2017,3,9), ClienteFK=4, TecnicoFK=1},
               new ReservaLugares {ID=2, LocalDaReserva="Tomar", DataDaReserva=new DateTime(2017,8,9), ClienteFK=10, TecnicoFK=2 },
               new ReservaLugares {ID=3, LocalDaReserva="Lisboa", DataDaReserva=new DateTime(2017,8,18), ClienteFK=1, TecnicoFK=3 },
               new ReservaLugares {ID=4, LocalDaReserva="Porto", DataDaReserva=new DateTime(2017,2,12), ClienteFK=8, TecnicoFK=4 }
            };
